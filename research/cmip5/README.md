...
| 27 | MPI-ESM-LR      | MPI-M, Germany  | Giorgetta et al. 2013 (doi:10.1002/jame.20038) | giorgetta_climate_2013 *(add)* | ☐ |
| 28 | MPI-ESM-MR      | MPI-M, Germany  | Giorgetta et al. 2013 | giorgetta_climate_2013 *(add)* | ☐ |
| 29 | MPI-ESM-P       | MPI-M, Germany  | Giorgetta et al. 2013 | giorgetta_climate_2013 *(add)* | ☐ |
| 30 | EC-EARTH        | EC-EARTH Consortium | Hazeleger et al. 2012 (doi:10.1175/BAMS-D-11-00094.1) | hazeleger_ecearth_2012 *(add)* | ☐ |
...
| 7  | MPI + EC-EARTH (Germany/Europe) | MPI-ESM-LR, MPI-ESM-MR, MPI-ESM-P, EC-EARTH | ☐ |
