...
| SI | Sulphate aerosol — indirect | Model-dependent | ~ unclear | ? | Indirect aerosol treatment in AM2.1 for ESM2G not confirmed from surviving evidence | — | — | |
...
| MD | Mineral dust | Model-dependent | ~ unclear | ? | Not confirmed; AM2.1 dust treatment not pinned down | — | — | |
...
| SO | Solar irradiance | Wang et al. 2005 | ~ unclear | ? | Wang et al. 2005 is the CMIP5 standard; not confirmed at ESM2G model level | Wang et al. 2005 | wang_modeling_2005 | Unverified at model level |
| VL | Volcanic aerosols | Sato et al. 1993 updated | ~ unclear | ? | Standard Sato updated; not confirmed at model level | Sato et al. 1993 | sato_stratospheric_1993 | Unverified at model level |
...
| BC on snow/ice | ? | Lamarque et al. 2010 | AM2.1 aerosol treatment; whether BC-snow cryosphere pathway is included unconfirmed |
...
4. Does ESM2G differ from ESM2M in any forcing detail (atmospheric forcing should be identical; ocean biogeochemistry forcing may differ due to isopycnal vs. z-level geometry)?
5. SO and VL: unconfirmed at model level.

## Provenance
- Durack et al. 2016 model list: included
- Sources consulted: GFDL ESM CMIP5 FAQ (gfdl.noaa.gov/esms-cmip5-faqs/); Dunne et al. 2012 Part I doi:10.1175/JCLI-D-11-00560.1; PCMDI CMIP5 forcing page; Taylor et al. 2012; Lamarque et al. 2013 (ACCMIP deposition)
