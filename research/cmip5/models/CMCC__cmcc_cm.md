...
- **Primary documentation paper(s):** No accessible primary CMIP5 model description paper identified. **Scoccimarro et al. 2011 (*J. Climate* 24:4368, doi:10.1175/2011JCLI4104.1) describes CMCC-MED (ECHAM5 T159 + embedded regional NEMO Mediterranean Sea model), NOT standalone CMCC-CM — see Stage E provenance (2026-06-28 correction).** Eyring et al. 2013 (*JGR* 118:5029, doi:10.1002/jgrd.50316) confirms O=✓std (Cionni2011 C1modB) via Table 1. [eyring_ozone_2013 *(add)*]
...
- Stage E 2026-06-22: Scoccimarro2011 PDF (`resources/Scoccimarroetal11JCL-CMCC-MEDTropicalCycloneEffectsOnOceanHeatTransport.pdf`) read with pdfminer. Paper describes CMCC_MED (Mediterranean configuration = CMCC-CM + embedded NEMO regional Med Sea model), NOT the standalone CMCC-CM. Model architecture confirmed: ECHAM5 T159L31 (top at 10 hPa) + OPA8.2 ORCA2 + OASIS3 coupler + LIM sea ice. Simulations follow IPCC 20C3M (1950–1999) and A1B (2000–2069) protocols — NOT CMIP5 historical. No aerosol, ozone, land-use, solar, or volcanic forcing datasets named. All ? cells remain ?. **Best available path to resolve open cells**: search for a dedicated CMCC tech report for CMCC-CM CMIP5 historical, or use ES-DOC CIM documents.
- 2026-06-28 correction: Scoccimarro 2011 removed as primary paper for CMCC-CM — it describes CMCC-MED, not CMCC-CM (see Stage E above and bib-to-add.md annotation). No primary CMIP5 model description paper for CMCC-CM has been identified. scoccimarro_effects_2011 bib key annotated as CMCC-MED-only in bib-to-add.md.
