...
|-----|---------|------------------------|---------|----------|-----------------|----------|---------|-------|
| G  | Well-mixed GHGs | Meinshausen et al. 2011 | ✓std (as CM5A-LR) | TV | As CM5A-LR — Meinshausen2011 CMIP5 recommended dataset confirmed from Dufresne2013 | dufresne_climate_2013 | dufresne_climate_2013 | Confirmed via CM5A-LR (Dufresne2013 Sect. 3.5–3.6 covers all IPSL-CM5 variants) |
...
| LU | Land-use change | Hurtt et al. 2011 | ✓std (as CM5A-LR) | TV | As CM5A-LR — Hurtt2011 (UNH) transient crop/pasture confirmed from Dufresne2013 | dufresne_climate_2013 | dufresne_climate_2013 | Confirmed via CM5A-LR (Dufresne2013 Sect. 3.7 covers all IPSL-CM5 variants) |
