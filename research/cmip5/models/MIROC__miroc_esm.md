...
|-----|---------|------------------------|---------|----------|-----------------|----------|---------|-------|
| G  | Well-mixed GHGs | Meinshausen et al. 2011 | **✓ std** | TV | Meinshausen et al. 2011 — Watanabe 2011 Sect. 3.2: "Atmospheric concentrations of well-mixed greenhouse gases are provided by Meinshausen et al. (2011)." Explicitly confirmed. | meinshausen_rcp_2011 | meinshausen_rcp_2011 | Confirmed explicitly in Watanabe 2011 Sect. 3.2. Second-pass update 2026-06-21. |
...
| LU | Land-use change | Hurtt et al. 2011 | **✓ std** | TV | Hurtt et al. (2009) harmonised land-use — Watanabe 2011 Sect. 3.2: "To appropriately incorporate the effects of anthropogenic land use, the harmonized land-use dataset (Hurtt et al., 2009) was implemented in the SEIB-DGVM." = Hurtt 2011 pre-publication version. | hurtt_harmonization_2011 | hurtt_harmonization_2011 | Confirmed explicitly in Watanabe 2011 Sect. 3.2. Second-pass update 2026-06-21. |
| SO | Solar irradiance | Wang et al. 2005 | **~** | TV | Lean et al. (2005) Solar Phys. 230:27–53 — Watanabe 2011 Sect. 3.2: "Spectral changes in solar irradiance are considered according to Lean et al. (2005)." Citation is to the SORCE paper, not Wang, Lean & Sheeley (2005) ApJ. Likely same underlying TSI dataset but citation ambiguity. | wang_modeling_2005 | wang_modeling_2005 | Nuanced: Lean 2005 explicitly named but as Solar Phys. 230 (SORCE paper) not ApJ (Taylor 2012 standard). Stage 9 refuted Lean2005 deviation claim; second pass resolves to ~. 2026-06-21. |
