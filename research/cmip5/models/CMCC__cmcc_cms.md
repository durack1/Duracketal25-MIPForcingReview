...
| O  | Ozone | Cionni et al. 2011 | ? | TV | CMCC-CMS absent from Eyring et al. (2013) Table 1 (confirmed by full PDF stream extraction). Two interpretations: (a) Cionni2011 hitop variant (physically required by L95 vertical grid; same as MPI-ESM/HadGEM2-CC) but absent from Table 1 for unknown reason; or (b) base MAECHAM5 Fortuin & Kelder (1998) fixed ozone climatology carried over — Manzini2006 S2a confirms MAECHAM5 uses "monthly zonal-mean climatological ozone distribution (Fortuin and Kelder 1998)". Absence from Eyring2013 Table 1 is slight evidence for (b). Unverified: no CMIP5-specific primary source. | Manzini et al. 2006; Eyring et al. 2013 | manzini_influence_2006 *(add)*; eyring_ozone_2013 | CMCC-CM vs CMCC-CMS ozone distinction confirmed; hitop vs Fortuin-Kelder ambiguity remains. **Stage E 2026-06-22.** |
...
- Stage E 2026-06-22: Manzini2006 PDF (`resources/Manzinietal06JCL-MAECHAM5-InfluenceOfSSTOnNorthernWinterStratosphere.pdf`) read with pdfminer. Key findings: (1) MAECHAM5 configuration T42L39 in 2006 paper (lower horizontal and vertical resolution than CMCC-CMS T63L95 — different config); (2) Ozone = monthly zonal-mean climatological distribution from Fortuin & Kelder (1998) — NOT Cionni2011; (3) AMIP-style simulations with prescribed observed SST/SIC (1980–1999) — no CMIP5 forcing datasets described. CMIP5 CMCC-CMS ozone remains ambiguous: either updated to hitop Cionni2011 OR retained Fortuin-Kelder 1998 climatology (absence from Eyring2013 Table 1 is consistent with the latter). All ? cells remain ?.
