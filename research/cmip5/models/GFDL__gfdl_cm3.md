...
| SO | Solar irradiance | Wang et al. 2005 | ~ unclear | ? | Standard is Wang et al. 2005 total solar irradiance reconstruction; not confirmed at CM3 model level from surviving evidence. | Wang et al. 2005 (standard) | wang_modeling_2005 | Unverified at model level |
| VL | Volcanic aerosols | Sato et al. 1993 updated | ~ unclear | ? | Standard is Sato et al. 1993 updated stratospheric aerosol OD; not confirmed at model level. Note: AM3's interactive aerosol scheme covers tropospheric species; volcanic stratospheric aerosol is typically still prescribed even in interactive-aerosol models. | Sato et al. 1993 (standard) | sato_stratospheric_1993 | Unverified. AM3 interactive aerosols likely do NOT include the stratospheric volcanic signal — that is almost certainly still prescribed from Sato. |
...
## Open questions
1. SO: Wang 2005 or different solar reconstruction? Unconfirmed at model level.
2. VL: Is volcanic stratospheric aerosol prescribed (Sato updated) as expected, or handled differently given the interactive aerosol scheme?
3. BC-on-snow: is the cryosphere albedo pathway from deposited BC explicitly included? Levy et al. 2013 likely addresses this.
4. Ozone chemistry: which emission species (NOx sources, VOCs) from Lamarque 2010 were used? Same inventory across all GFDL models?

## Provenance
- Durack et al. 2016 model list: included
- Sources consulted: GFDL AM3 model page (gfdl.noaa.gov/am3-model/); GFDL CM3 page (gfdl.noaa.gov/coupled-physical-model-cm3/); Donner et al. 2011 J. Climate doi:10.1175/2011JCLI3955.1; Taylor et al. 2012 BAMS; PCMDI CMIP5 forcing page
