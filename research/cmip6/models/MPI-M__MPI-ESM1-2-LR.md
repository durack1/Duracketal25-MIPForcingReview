...
|-----|---------|------------------------|---------------------|---------|----------|-----------------|----------|-------|
| G  | Well-mixed GHGs | Meinshausen et al. 2017 | `UoM-CMIP-1-2-0` | ✓std | TV | **Meinshausen et al. 2017** (UoM-CMIP-1-2-0). input4MIPs uniqueness: only one CMIP6 historical GHG dataset exists (368 datasets, 1 source_id); no deviation evidence for MPI. | ESGF input4MIPs catalog 2026-06-28 | input4MIPs uniqueness (confirmed 2026-06-28); Mauritsen 2019 CMIP6 protocol compliance |
...
| SO | Solar irradiance | Matthes et al. 2017 SOLARIS-HEPPA-3-2 | `SOLARIS-HEPPA-3-2` | ✓std | TV | **Matthes et al. 2017 / SOLARIS-HEPPA-3-2**. input4MIPs uniqueness: only one CMIP6 historical solar dataset exists (6 datasets, 1 source_id); no deviation evidence for MPI. | ESGF input4MIPs catalog 2026-06-28 | input4MIPs uniqueness (confirmed 2026-06-28) |
| VL | Volcanic aerosols | IACETH SAGE3λ v3.0.0 | `IACETH-SAGE3lambda-3-0-0` | ✓std | TV | **IACETH-SAGE3lambda-3-0-0**. input4MIPs uniqueness (only CMIP6 stratospheric aerosol dataset); Mauritsen 2019 §8.2 confirms VL IS prescribed in historical ("as volcanoes are activated") — dual confirmation. | Mauritsen et al. 2019; ESGF input4MIPs catalog 2026-06-28 | VL confirmed prescribed (Mauritsen 2019) + IACETH uniqueness (confirmed 2026-06-28) |
| FC | Flux corrections | Not expected | — | n/a | n/a | None | — | |

### Deviations from Eyring 2016 standard protocol
- **No confirmed deviations** on any resolved forcings: G/O/SO/VL=✓std; SD/BC/OC/SI=✓std (MACv2-SP prescribed path). MACv2-SP uses CMIP6 emission inventory as temporal scaling index.
- **CMIP5 correction**: SD/BC/OC upgraded from MAC-v1 (✗dev) to MACv2-SP (✓std prescribed path). Major improvement.
- **MD/SS = FXc**: Natural aerosol from Kinne 2013 fixed climatology — not time-varying. Consistent with the prescribed-aerosol path.
...
- **Stage 9 full text review (Mauritsen et al. 2019 JAMES; 2026-06-27)**: Complete paper re-read confirms volcanic stratospheric aerosols ARE prescribed in historical simulations (section 8.2, lines noting "zero volcanic stratospheric aerosols" in piControl vs. "volcanoes are activated" in historical), but the specific dataset name (IACETH SAGE3λ) is NOT stated anywhere in the paper. Meinshausen 2017 (G) and Matthes 2017 (SO) are also not cited. N-deposition confirmed: "Gridded coupled chemistry model intercomparison N-deposition fields of version 1.0 are used as provided via the CMIP6 input database" (section 5.2) — this corresponds to NCAR-CCMI-2-0 (input4MIPs).
- **Seventh-pass update (2026-06-28)**: G, SO, VL resolved to ✓std via input4MIPs uniqueness argument. ESGF catalog (confirmed 2026-06-28): UoM-CMIP-1-2-0 is the ONLY CMIP6 historical GHG dataset; SOLARIS-HEPPA-3-2 is the ONLY solar dataset; IACETH-SAGE3lambda-3-0-0 is the ONLY stratospheric aerosol dataset. Mauritsen 2019 §8.2 corroborates VL prescribed. No evidence of deviation from standard CMIP6 protocol for any of these three forcings.
...
## Open questions
~~1. **G**: resolved 2026-06-28 → ✓std (input4MIPs uniqueness)~~
~~2. **SO**: resolved 2026-06-28 → ✓std (input4MIPs uniqueness)~~
~~3. **VL**: resolved 2026-06-28 → ✓std (input4MIPs uniqueness + Mauritsen 2019 §8.2 prescribed)~~
1. **N-dep, CO2-mode, Fe**: ESM inputs unconfirmed
