...
| SO | Solar irradiance | Matthes et al. 2017 SOLARIS-HEPPA-3-2 | `SOLARIS-HEPPA-3-2` | ✓std | TV | **Matthes et al. 2017 / SOLARIS-HEPPA-3-2**. input4MIPs uniqueness: only one CMIP6 historical solar dataset; no deviation evidence; CMIP5 IPSL used Wang2005 (✓std), CMIP6 continuation with Matthes2017 standard. Lurton 2020 (IPSL CMIP6 forcing implementation) expected to confirm explicitly. | ESGF input4MIPs catalog 2026-06-28 | Resolved via input4MIPs uniqueness (2026-06-28); Lurton 2020 not retrieved but expected to corroborate |
...
## Open questions
~~1. **SO**: resolved 2026-06-28 → ✓std (input4MIPs uniqueness; SOLARIS-HEPPA-3-2 only option; no deviation evidence)~~
1. **N-dep**: NCAR-CCMI-2-0 expected for ORCHIDEE active C but not confirmed in Boucher 2020 or Hourdin 2020
