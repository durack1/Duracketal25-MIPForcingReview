...
| LU | Land-use change | ~ | ? | **Not addressed in Volodin & Gritsun 2018.** The paper explicitly lists all "prescribed as recommended for CMIP6" forcings: CO2, CH4, N2O, O3, stratospheric volcanic sulfate, TSI, solar spectrum — LU is conspicuously absent. INM-CM4 (CMIP5 predecessor) used sparse forcing set; same pattern likely. UofMD-landState-2-1-h (LUH2) is the only CMIP6 historical land-state dataset in input4MIPs. | Volodin & Gritsun 2018; ESGF input4MIPs catalog 2026-06-28 | **Inference from omission**: LU absent from paper's standard-forcing list (verbatim enumeration). Likely n/a (fixed land cover) or non-standard. Confirmed-absent from CMIP6 recommended forcing set. |
