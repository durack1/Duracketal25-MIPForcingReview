...
| SD | Sulphate aerosol — direct | Y | ~ supports | TV (inferred) | Sulphate aerosol applied in 20C3M (referenced in PCMDI 20C3M section) but **specific dataset not named**. Claim that BCCR shared Boucher & Pham 2002 dataset with CNRM-CM3 (shared ARPEGE atmosphere) was adversarially **REFUTED** — Furevik 2003 describes a control run and specifies no 20C3M aerosol datasets. | PCMDI BCCR_BCM2.0.htm §V.C; Furevik et al. 2003 (refuted Boucher-shared hypothesis) | furevik_description_2003 | SD=Y inferred from PCMDI reference; source dataset unconfirmed |
...
- **None confirmed.** SO=- and VL=- are correct (genuine omissions confirmed by PCMDI verbatim quote). SD=Y is consistent (sulphate applied), though dataset source unconfirmed.

### Open questions
1. **SD dataset**: Which sulphate aerosol dataset did BCCR-BCM2.0 use for 20C3M? The Boucher & Pham 2002 (shared with CNRM) hypothesis was refuted. The PCMDI page references sulphate without naming the source.
...
- Sources consulted: PCMDI BCCR_BCM2.0.htm (primary — GHG ENSEMBLES + solar/volcanic confirmed verbatim; URL uses underscore); Furevik et al. 2003 *Clim. Dyn.* doi:10.1007/s00382-003-0317-5 (control run — flux adjustment confirmed; does NOT document 20C3M forcing datasets)
- Stage 10 adversarial workflow: wf_736d8594-819; 10 claims confirmed, 4 killed. SO=VL=- confirmed high confidence. Boucher & Pham 2002 BCCR-shared hypothesis REFUTED.
