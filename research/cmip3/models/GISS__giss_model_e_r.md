# giss_model_e_r — GISS (NASA Goddard Institute for Space Studies, USA)

- **CMIP phase:** CMIP3 (20C3M, transient 1880–2003)
- **Model family / lineage:** GISS ModelE → ModelE2 (CMIP5: E2-H/E2-R) → ModelE2.1 (CMIP6). "-R" = Russell ocean (Ocean C, Russell 1995).
- **Atmosphere / ocean components:** ModelE atmosphere; Russell ocean. **Atmospheric forcings IDENTICAL to ModelE-H** (confirmed: "alternative ocean representations with identical atmospheric model").
- **Primary documentation paper(s):** Schmidt et al. 2006, *J. Climate* 19:153–192 — doi:10.1175/JCLI3612.1 *(given)*; Hansen et al. 2007, *Clim. Dyn.* 29:661–696 — doi:10.1007/s00382-007-0255-8 (authoritative 1880–2003 transient/20C3M forcing documentation).
...
- Sources (deep-research wf_0428cb12-249): Schmidt et al. 2006; Hansen et al. 2007 (arXiv physics/0610109); GISS ModelE transient forcings page; GISS strataer/LULC data pages.
